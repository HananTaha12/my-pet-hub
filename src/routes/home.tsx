      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        {!showMiniChat && (
          <button
            ...
            className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-[#D98CB3] to-[#4E1B33] text-white shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 cursor-pointer animate-bounce-slow border border-white/20 group"
            title="Ask PetPal AI Coach"
          >
            <Bot className="h-7 w-7 text-white" />
            <span className="absolute right-16 bg-black/80 backdrop-blur-md text-white text-[10px] font-black px-2.5 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-xl">
              🤖 PetPal AI Coach
            </span>
          </button>
        )}
